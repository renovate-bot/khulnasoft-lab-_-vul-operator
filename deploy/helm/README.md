...
* <https://github.com/khulnasoft-lab/vul-operator>
...
| image.repository | string | `"khulnasoft-lab/vul-operator"` |  |
...
| nodeCollector.imagePullSecret | string | `nil` | imagePullSecret is the secret name to be used when pulling node-collector image from private registries example : reg-secret It is the user responsibility to create the secret for the private registry in `vul-operator` namespace |
| nodeCollector.registry | string | `"ghcr.io"` | registry of the node-collector image |
| nodeCollector.repository | string | `"khulnasoft-lab/node-collector"` | repository of the node-collector image |
