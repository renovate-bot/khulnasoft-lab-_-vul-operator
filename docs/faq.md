...
property of the container definition. Vul-operator relies on label selectors to
...
kubectl get vulnerabilityreports \
  -l vul-operator.resource.kind=Deployment \
  -l vul-operator.resource.name=wordpress
```
