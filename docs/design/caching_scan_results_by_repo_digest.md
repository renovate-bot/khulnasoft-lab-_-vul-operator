...
mitigated by using Starboard with Vul in the [ClientServer] mode instead of
...
My suggestion is to solve this problem just like we did in [PR #879](https://github.com/khulnasoft-lab/starboard/pull/879).
For each ClusterVulnerabilityReport created we should annotate the report with `starboard.khulnasoft-lab.github.io/cluster-vulnerability-report-ttl`.
...
For example: `starboard.khulnasoft-lab.github.io/ClusterVulnerabilityReportName: 84bcb5cd46` would make it easy to find.
