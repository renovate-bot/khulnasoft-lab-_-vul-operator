...
For this tutorial, we will use the [Operator Helm Chart.](https://khulnasoft-lab.github.io/vul-operator/latest/operator/installation/helm/)

The configuration options for the Helm Chart can be found in the [values.yaml](https://github.com/khulnasoft-lab/vul-operator/blob/main/deploy/helm/values.yaml) manifest.
...
For additional information, please refer to the [documentation on managed registries.](https://khulnasoft-lab.github.io/vul-operator/v0.16.3/docs/vulnerability-scanning/managed-registries/)
