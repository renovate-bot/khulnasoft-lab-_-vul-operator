...
My suggestion is to solve this problem just like we did in [PR #879](https://github.com/khulnasoft-lab/vul-operator/pull/879).
For each ClusterVulnerabilityReport created we should annotate the report with `vul-operator.khulnasoft-lab.github.io/cluster-vulnerability-report-ttl`.
...
For example: `vul-operator.khulnasoft-lab.github.io/ClusterVulnerabilityReportName: 84bcb5cd46` would make it easy to find.
...
[Standalone]: https://khulnasoft-lab.github.io/vul-operator/v0.16.3/integrations/vulnerability-scanners/vul/#standalone
[ClientServer]: https://khulnasoft-lab.github.io/vul-operator/v0.16.3/integrations/vulnerability-scanners/vul/#clientserver
