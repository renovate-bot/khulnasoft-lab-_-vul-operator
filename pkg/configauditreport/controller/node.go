...
// +kubebuilder:rbac:groups=khulnasoft-lab.github.io,resources=clusterinfraassessmentreports,verbs=get;list;watch;create;update;patch;delete
...
func (r *NodeReconciler) reconcileNodes() reconcile.Func {
	return func(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
		...
		tc := vul.Config{PluginConfig: pConfig}
