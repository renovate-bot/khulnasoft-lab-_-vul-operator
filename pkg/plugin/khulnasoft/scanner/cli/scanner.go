...
func (s *Scanner) getFSScanCommand(imageRef string) *exec.Cmd {
	...
	command := exec.Command("/var/khulnasoft/scannercli", args...)
	return command
}

func (s *Scanner) convert(imageRef string, khulnasoftReport ScanReport) (report v1alpha1.VulnerabilityReportData, err error) {
