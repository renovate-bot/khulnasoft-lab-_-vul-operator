						...
						Vulnerabilities: []v1alpha1.Vulnerability{
							{
								...
								PrimaryLink:     "https://avd.khulnasoft.com/nvd/cve-2019-1549",
								Score:           pointer.Float64Ptr(8.2),
							},
							{
								VulnerabilityID: "CVE-2019-1547",
								Severity:        v1alpha1.SeverityLow,
								PrimaryLink:     "https://avd.khulnasoft.com/nvd/cve-2019-1547",
								Score:           pointer.Float64Ptr(6.3),
							},
							{
								VulnerabilityID: "CVE-2011-3374",
								Severity:        v1alpha1.SeverityMedium,
								PrimaryLink:     "https://avd.khulnasoft.com/nvd/cve-2011-3374",
						...
						Vulnerabilities: []v1alpha1.Vulnerability{
							{
								...
								Severity:        v1alpha1.SeverityCritical,
								PrimaryLink:     "https://avd.khulnasoft.com/nvd/cve-2019-1548",
							...
							},
							{
								...
								Severity:        v1alpha1.SeverityMedium,
								PrimaryLink:     "https://avd.khulnasoft.com/nvd/cve-2020-27350",
