...
type Config struct {
	...
	ServiceAccount                               string         `env:"OPERATOR_SERVICE_ACCOUNT" envDefault:"vul-operator"`
	...
	LeaderElectionID                             string         `env:"OPERATOR_LEADER_ELECTION_ID" envDefault:"vuloperator-lock"`
	...
	BuiltInVulServer                           bool           `env:"OPERATOR_BUILT_IN_VUL_SERVER" envDefault:"false"`
	VulServerHealthCheckCacheExpiration        *time.Duration `env:"VUL_SERVER_HEALTH_CHECK_CACHE_EXPIRATION" envDefault:"10h"`
