...
// ToComplainceSpec map data from crd compliance spec to vul compliance spec
...
// FromSummaryReport map data from vul summary report to crd summary report
...
// FromDetailReport map data from vul summary report to crd summary report
