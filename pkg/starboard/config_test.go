...
func TestConfigData_GetKubeBenchImageRef(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			configData: starboard.ConfigData{
				"kube-bench.imageRef": "gcr.io/khulnasoft-lab/kube-bench:0.4.0",
			},
			expectedImageRef: "gcr.io/khulnasoft-lab/kube-bench:0.4.0",
		},
	}
...
func TestConfigData_GetKubeHunterImageRef(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			name: "Should return image reference from config data",
			configData: starboard.ConfigData{
				"kube-hunter.imageRef": "gcr.io/khulnasoft-lab/kube-hunter:0.4.0",
			},
			expectedImageRef: "gcr.io/khulnasoft-lab/kube-hunter:0.4.0",
		},
	}
