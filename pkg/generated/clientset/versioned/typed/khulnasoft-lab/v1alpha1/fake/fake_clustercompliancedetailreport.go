...
type FakeClusterComplianceDetailReports struct {
	Fake *FakeKhulnaSoftsecurityV1alpha1
	ns   string
}

var clustercompliancedetailreportsResource = schema.GroupVersionResource{Group: "khulnasoft-lab.github.io", Version: "v1alpha1", Resource: "clustercompliancedetailreports"}

var clustercompliancedetailreportsKind = schema.GroupVersionKind{Group: "khulnasoft-lab.github.io", Version: "v1alpha1", Kind: "ClusterComplianceDetailReport"}
