	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KhulnaSoftsecurityV1alpha1().ClusterConfigAuditReports().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KhulnaSoftsecurityV1alpha1().ClusterConfigAuditReports().Watch(context.TODO(), options)
			},
		},
		&khulnasoft-labv1alpha1.ClusterConfigAuditReport{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterConfigAuditReportInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&khulnasoft-labv1alpha1.ClusterConfigAuditReport{}, f.defaultInformer)
}
