	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KhulnasoftV1alpha1().KubeHunterReports().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KhulnasoftV1alpha1().KubeHunterReports().Watch(context.TODO(), options)
			},
		},
		&khulnasoftv1alpha1.KubeHunterReport{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *kubeHunterReportInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&khulnasoftv1alpha1.KubeHunterReport{}, f.defaultInformer)
}
